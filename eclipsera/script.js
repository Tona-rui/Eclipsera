...
const comments = {
  0: {
    ...
    body: "정통 트랜스?에 가까운 느낌입니다. 앞이야기와 뒷이야기가 상반된걸 생각하고 만들었는데 뭔가 잘 어울릴지 모르겠습니다. 듣기 조금 지루하지 않을까 라는 생각이 듭니다??  다음엔 요즘 시대에 맞는 하이퍼트랜스라던가 재밌는 걸 주력으로 만들어 보겠습니다. 여러모로 아쉽지만 좋은 밑거름이 될 거 같네요! "
  },
  1: {
  ...
  2: {
    title: "pluto - prsgt",
    body: "심플한 트랜스입니다. disc 1의 컨셉이 컨셉인지라 화성이라든지 전개라든지, 평소 습관을 최대한 담아서 만들었네요, 덕분에 별로 힘들진 않았습니다. 많은 고민을 거치지 않은 것 치고는 꽤 마음에 들지도? 다만 다음번엔 더 많은 고민을 해 보는 걸로... 명왕성은 혼자 동떨어져 있다는 느낌이 있죠. 슬플 것 같네요."
  },
  3: {
    title: "Open Portal - Tonarui",
    body: "처음으로 완곡해서 만들어본 하이테크에요! 앨범 이미지를 항상 생각해서 난잡하고 하이테크 특유의 재밌는 느낌을 많이 주려고 했어요. Output 사의 Portal도 사용해서 재미를 좀 봤습니다.(비싸다) 너무 만족스럽네요. 하이테크 최고!"
  },
  4: {
  ...
  5: {
    title: "ujumia - prsgt",
    body: "테크노입니다. 좋아하는 테크노들의 특징을 담아 최대한 멜로디를 배제하기도 하고, 미묘한 코드 진행을 하기도 했습니다... 만 어째선지 기묘한 곡이 되어버렸네요. 곡조 자체는 우주에서 부조리한 이유로 길을 잃은 느낌으로 만들고자 했습니다. 우주미아네요. 다음엔 럼블 킥이 인상깊은 다크 테크노를 만들어보고 싶습니다."
  }
};
